...
pSTEP = Pin(5, Pin.OUT)    # create output pin on GPIO16  B2 coilB red    NEMA14
pDIR = Pin(6, Pin.OUT)     # create output pin on GPIO17  B1 coilB blue   NEMA14
pEN = Pin(7, Pin.OUT)
pSLP = Pin(3, Pin.OUT, Pin.PULL_UP)
pRST = Pin(4, Pin.OUT, Pin.PULL_UP)      # create output pin on GPIO18  A1 coilA black  NEMA14
